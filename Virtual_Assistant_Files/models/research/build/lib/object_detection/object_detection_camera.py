...
PATH_TO_CKPT = os.path.join(CWD_PATH, os.path.join('inference_graph', 'checkpoint'))
PATH_TO_CFG = os.path.join(CWD_PATH, os.path.join('inference_graph', 'pipeline.config'))


# Download labels file
LABEL_FILENAME = 'labelmap.pbtxt'
PATH_TO_LABELS = os.path.join(CWD_PATH, os.path.join('training_detector', LABEL_FILENAME))
...
while True:
    ...
    image_np[:,:,2] = np.clip(contrast * image_np[:,:,2] + brightness, 0, 255)
